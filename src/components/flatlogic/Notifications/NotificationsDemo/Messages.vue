  ...
  <b-list-group class="listGroup thin-scroll">
    <b-list-group-item class="listGroupItem bg-warning-light">
      <span class="notificationIcon thumb-sm">
        <img class="rounded-circle" src="@styles/assets/people/a2.jpg" alt="..." />
    ...
    <b-list-group-item class="listGroupItem">
      <span class="notificationIcon thumb-sm">
        <img class="rounded-circle" src="@styles/assets/people/a1.jpg" alt="..." />
    ...
    <b-list-group-item class="listGroupItem">
      <span class="notificationIcon thumb-sm">
        <img class="rounded-circle" src="@styles/assets/people/a6.jpg" alt="..." />
    ...
    <b-list-group-item class="listGroupItem">
      <span class="notificationIcon thumb-sm">
        <img class="rounded-circle" src="@styles/assets/people/a4.jpg" alt="..." />
